...
const VendorItem = (props) => {
    ...
    const renderInfo = () => {
            ...
            return <React.Fragment>
                <View style={[Theme.styles.row_center_start, { width: '100%', marginTop: 4 }]}>
                    ...
                    <AppText style={[styles.text, { paddingHorizontal: 10 }]}>|</AppText>
                    {
                        ...
                        <React.Fragment>
                            <Entypo name="location-pin" size={22} color={Theme.colors.gray7} style={{ marginLeft: -2, marginRight: 2 }} />
                    ...
                    <MaterialIcons name="access-time" size={19} color={Theme.colors.gray7} style={{ marginRight: 5 }} />
                    <AppText style={[styles.text]}>{data.max_pickup_time} {translate('vendor_profile.mins')}</AppText>
                </View>
            </React.Fragment>
        }
        ...
        return <React.Fragment>
            ...
            <View style={[Theme.styles.row_center_start, { width: '100%', paddingLeft: 2, marginTop: !isEmpty(data.min_delivery_time) ? 4 : 8 }]}>
    ...
    return <View
        ...
        <TouchableOpacity
            ...
            />
            <View
                style={styles.photoTransWrap}
            />
            <View style={{ position: 'absolute', left: 10, bottom: 0, maxWidth: 240 }}>
                <VendorItemSmallOrderFeeTooltip onSelect={() => onSelect()} title={data.title} isOpen={is_open} delivery_minimum_order_price={data.delivery_minimum_order_price}
            ...
            <TouchableOpacity onPress={() => onSelect()} style={[Theme.styles.col_center, styles.logoView]} activeOpacity={1}>
                <FastImage
            ...
            {
                isLoggedIn && <TouchableOpacity style={styles.favBtn} onPress={() => onPressFav(data)}>
                    <AntDesign name="heart" size={22} color={data.isFav == 1 ? Theme.colors.cyan2 : Theme.colors.gray5} />
                </TouchableOpacity>
            }
            {is_open != 1 &&
                <View
                    style={[Theme.styles.col_center, styles.closedBg]}
                >
                    <TouchableOpacity
                    ...
                    >
                        {canSchedule ?
                            <Svg_calendar width={20} height={20} /> : null
                        }
        ...
        <View style={[Theme.styles.flex_1, { marginTop: 6, flexDirection: 'column', justifyContent: 'space-evenly', alignItems: 'stretch' }]}>
            <View style={[Theme.styles.row_center_start, { width: '100%', alignItems: 'flex-start' }]}>
                <View style={{ flex: 1, paddingRight: 12, flexDirection: 'column', justifyContent: 'space-between' }}>
                    {renderInfo()}
                </View>
            </View>
        </View>
...
const styles = StyleSheet.create({
    container: { width: (width(100) - 40), alignItems: 'center', borderRadius: 15, backgroundColor: Theme.colors.white, marginRight: 16, },
    ...
    photoTransWrap: { width: '100%', height: 170, borderRadius: 10, backgroundColor: '#00000033', position: 'absolute', top: 0, left: 0 },
    isOpenImage: { width: 40, height: 50, resizeMode: 'contain', backgroundColor: 'transparent' },
    logoView: { position: 'absolute', right: 8, bottom: 8, width: 108, height: 108, borderRadius: 10, backgroundColor: '#F6F6F9' },
    ...
    description: { marginTop: 5, fontSize: 15, lineHeight: 15, color: Theme.colors.gray7, fontFamily: Theme.fonts.medium, },
    ...
    statusBar: { position: 'absolute', top: 10, left: 0, paddingHorizontal: 16, height: 28, backgroundColor: Theme.colors.cyan2, borderTopRightRadius: 14, borderBottomRightRadius: 14 },
    ...
    opencloseBtn: { paddingVertical: 12, paddingHorizontal: 14, backgroundColor: Theme.colors.white, borderRadius: 40, marginRight: 10, minWidth: 90, height: 40 },
    opencloseTxt: { fontSize: 13, lineHeight: 15, color: Theme.colors.text, fontFamily: Theme.fonts.semiBold, textTransform: 'uppercase' },
    availableAt: { marginTop: 4, fontSize: 15, lineHeight: 17, color: Theme.colors.white, fontFamily: Theme.fonts.semiBold, },
