export default {
	...
	tooltip: {
		...
		platinium:
			'Λαμβάνετε X% επιστροφή μετρητών για κάθε παραγγελία στο Snapfood, ενώ βρίσκεστε σε αυτό το επίπεδο.',
		platinium_2:
			'Σημείωση: Θα χρειαστεί να κάνετε τουλάχιστον 1 παραγγελία την εβδομάδα στο Snapfood, για να παραμείνετε στο ίδιο επίπεδο.',
		silver: 'Λαμβάνετε X% επιστροφή μετρητών για κάθε παραγγελία στο Snapfood, ενώ βρίσκεστε σε αυτό το επίπεδο.',
		silver_2:
			'Ολοκληρώθηκαν 10 παραγγελίες ενώ βρίσκεστε σε επίπεδο Silver, σας αναβαθμίζουν αυτόματα σε επίπεδο GOLD.',
		silver_3:
			'Σημείωση: Θα χρειαστεί να κάνετε τουλάχιστον 1 παραγγελία την εβδομάδα στο Snapfood, για να παραμείνετε στο ίδιο επίπεδο.',
		gold: 'Λαμβάνετε X% επιστροφή μετρητών για κάθε παραγγελία στο Snapfood, ενώ βρίσκεστε σε αυτό το επίπεδο.',
