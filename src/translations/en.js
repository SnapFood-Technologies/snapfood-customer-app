export default {
	...
	tooltip: {
		...
		platinium: "You get 3% cashback for each order on Snapfood, while you're on this level.",
		platinium_2: "Note: You'll need to make at least 1 order a week on Snapfood, to remain at the same level.",
		silver: "You get 1% cashback for each order on Snapfood, while you're on this level.",
		...
		gold: "You get 2% cashback for each order on Snapfood, while you're on this level.",
	...
	vendor_voice_order: {
		voice_recording: 'Voice Order',
		item1Text: 'Clearly indicate the products you want and their quantity. The restaurant name is optional',
		item2Text: 'Your address and phone number will be automatically saved from your SnapFood profile information',
		item3Text: 'Click the microphone icon to place your order immediately',
		faq: 'Frequently asked questions',
		info: 'Voice orders simplify your in-app experience. All you have to do is clearly pronounce your order, and SnapFood takes care of the rest. The best alternative when your hands are busy or you\'re on the go.',
		example: 'Example',
		example_info: '4 family pizzas and 1 coca cola',
	},
