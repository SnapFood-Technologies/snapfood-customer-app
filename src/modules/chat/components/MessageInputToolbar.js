				...
				{this.props.quote_msg != null && (
					...
					>
						<View style={[Theme.styles.col_center, { flex: 1, alignItems: 'flex-start' }]}>
							<Text style={styles.quote_name}>
								{this.props.quote_msg.user.username || this.props.quote_msg.user.full_name}
							</Text>
							<Text numberOfLines={1} style={styles.quote_text}>
								{this.props.quote_msg.text}
							</Text>
						</View>
						<TouchableOpacity
							style={{ marginLeft: 8 }}
							onPress={this.props.onCancelQuote ? this.props.onCancelQuote : () => {}}
						>
...
MessageInputToolbar.propTypes = {
	...
	primaryStyle: PropTypes.oneOfType([PropTypes.object, PropTypes.array]),
