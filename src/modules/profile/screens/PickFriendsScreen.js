...
import { getFriends, setBalanceTransferPickedUser } from '../../../store/actions/app';
...
class PickFriendsScreen extends React.Component {
	constructor(props) {
		super(props);
		this.state = {
			all_friends: [],
	...
	onGoDetail = async (user) => {
		await this.props.setBalanceTransferPickedUser(user);
	...
	renderTitleBar() {
		return (
			<View style={styles.titleContainer}>
				...
				/>
				<Text style={styles.title}>{translate('transfer_balance.select_recipient')}</Text>
			</View>
		);
	}
...
export default connect(mapStateToProps, { getFriends, setBalanceTransferPickedUser })(PickFriendsScreen);
